...
for file in os.listdir(path)[::-1]:
    if fnmatch.fnmatch(file,'w64_black*'):       #Customize this to what pkgs you need 2. Can wildcard with * for all packages, or all of a certain type.
...
def TryNewFile():
    ...
    InitialiseFiles(LoadFiles,InstCount,refs)
